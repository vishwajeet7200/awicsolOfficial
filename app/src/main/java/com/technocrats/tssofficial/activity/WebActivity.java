...
import com.technocrats.tssofficial.adapters.PagerViewAdapter1;
...
public class WebActivity extends AppCompatActivity {
    ...
    private PagerViewAdapter1 pagerViewAdapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        getSupportActionBar().setTitle("Website Section");
        ...
        pagerViewAdapter = new PagerViewAdapter1(getSupportFragmentManager());
