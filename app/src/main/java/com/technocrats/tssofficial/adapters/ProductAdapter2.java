...
public class ProductAdapter2 extends RecyclerView.Adapter<ProductAdapter2.ProductViewHolder> {
    ...
    public ProductAdapter2(Context context, List<Products> productsList) {
    ...
    @Override
    public void onBindViewHolder(@NonNull final ProductAdapter2.ProductViewHolder holder, final int position) {
