...
public class ProductAdapter4 extends RecyclerView.Adapter<ProductAdapter4.ProductViewHolder> {
    ...
    public ProductAdapter4(Context context, List<Products> productsList) {
    ...
    @NonNull
    @Override
    public ProductAdapter4.ProductViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {

        View view = LayoutInflater.from(context).inflate(R.layout.products_row_item, parent, false);
        return new ProductAdapter4.ProductViewHolder(view);
    }

    @Override
    public void onBindViewHolder(@NonNull final ProductAdapter4.ProductViewHolder holder, final int position) {
