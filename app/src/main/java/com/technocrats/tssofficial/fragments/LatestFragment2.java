...
import com.technocrats.tssofficial.adapters.ProductAdapter5;
...
public class LatestFragment2 extends Fragment {
    ...
    ProductAdapter5 productAdapter5;

    @Override
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
                             Bundle savedInstanceState) {
        // Inflate the layout for this fragment
        view = inflater.inflate(R.layout.fragment_latest2, container, false);
    ...
    private void setProdItemRecycler1(List<Products> productsList){
        ...
        productAdapter5 = new ProductAdapter5(getContext(), productsList);
        prodItemRecycler1.setAdapter(productAdapter5);
